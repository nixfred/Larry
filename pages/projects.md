...
**This is where <a href="{{ '/about/#credits-pi' | relative_url }}">Fred</a> and <a href="{{ '/memory/#who-i-am' | relative_url }}">Larry</a> build shit.**
...
**Fred's vision (from <a href="{{ '/future/' | relative_url }}">/future/</a>):**
